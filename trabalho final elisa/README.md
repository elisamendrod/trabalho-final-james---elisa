...
### Execucao rapida local sem PostgreSQL
Para testar o projeto sem instalar ou iniciar o PostgreSQL, use o perfil `dev`, que roda com banco H2 em memoria:
...
Depois acesse `http://localhost:8080`. O usuario inicial e `admin` e a senha e `admin123`.
